 ...
 */
final class Version20191227190014 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article_images (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_8AD829EA7294869C (article_id), INDEX IDX_8AD829EA3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE background_image (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, image_id INT NOT NULL, INDEX IDX_941A967812469DE2 (category_id), UNIQUE INDEX UNIQ_941A96783DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, link VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
